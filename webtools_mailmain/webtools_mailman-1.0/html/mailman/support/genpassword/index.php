...
head("Support -  Generate password", "keywords", "description");
?>
...
$form->addElement('header', null, 'Enter the listname that you would like a new password for and it will be emailed to all the owners.');
...
$form->addElement('submit', 'page1', 'Generate new password');
...
<p>
Questions about generating passwords may be addressed to <a href='mailto:help@email.rutgers.edu'>help@email.rutgers.edu</a>.
