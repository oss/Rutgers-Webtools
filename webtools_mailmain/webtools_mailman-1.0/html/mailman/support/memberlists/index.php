...
head("Support - List of member lists", "keywords", "description");
?>
...
$form->addElement('header', null, 'Enter the subscribers email address to search all list memberships.');
$form->addElement('static', null, '&nbsp;');

$form->addElement('text', 'email', 'Email Address:', array('size' => 40, 'maxlength' => 127));
$form->addElement('static', null, '&nbsp;');
...
<p>
Questions about what lists a member is subscribed to may be addressed to <a href='mailto:help@email.rutgers.edu'>help@email.rutgers.edu</a>.
