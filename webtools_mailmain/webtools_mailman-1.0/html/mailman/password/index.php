...
head("Request a new Mailman list password", "keywords", "description");
?>
...
$form->addElement('header', null, 'Choose the list that you would like a new password for and a new one will be emailed to you and any other owners.');
...
<p>
Questions about Mailman passwords may be addressed to <a href='mailto:help@email.rutgers.edu'>help@email.rutgers.edu</a>.
